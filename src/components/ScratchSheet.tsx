 ...
 * Deliberately has no dismiss affordance — once a ticket is picked the only
 * way forward is to scratch it open.
 */
        ...
        >
          ...
          >
            ...
            <p className="mb-5 mt-1 text-center text-sm text-white/85">
              {instant ? 'Ketuk kartu untuk membuka bonus poin mu.' : 'Gosok area perak untuk membuka bonus poin mu.'}
            </p>

            <ScratchCard instant={instant} onComplete={() => window.setTimeout(onScratched, instant ? 150 : 850)}>
